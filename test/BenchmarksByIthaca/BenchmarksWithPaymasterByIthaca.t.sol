...
contract BenchmarksWithPaymasterByIthaca is InitBenchmarksByIthaca, UniSwapV2 {
    ...
    function testNativeTransfer_OPFAccount_VERIFYING_MODE() external depositAndStakeEP {
    ...
    function testERC20Transfer_OPFAccount_VERIFYING_MODE() external depositAndStakeEP {
    ...
    function testUniswapV2Swap_OPFAccount_VERIFYING_MODE() external depositAndStakeEP {
    ...
    function test10Batch_OPFAccount_VERIFYING_MODE() external depositAndStakeEP {
        uint256 balanceBefore = IERC20(erc20).balanceOf(random);
