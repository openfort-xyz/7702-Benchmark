...
import {BaseBenchmark} from "test/BenchmarksByIthaca/BaseBenchmark.t.sol";
...
contract BenchmarkSwapERC20ToETH is BaseBenchmark {
    ...
    function test_BenchmarkSwapERC20ToETH() public {
