...
contract BenchmarksWebAuthnSessionKeyBatch10 is DeployAccount {
    ...
    function setUp() public override {
        ...
        _createCustomFreshKey(
            false, KeyType.WEBAUTHN, uint48(block.timestamp + 1 days), 0, 1000, _getKeyP256(pK_SK), KeyControl.Self
        );
        _initializeAccount();
    ...
    function test_SendBatch10CallWithWebAuthnSessionKeyDirectAA() external {
        ...
        _relayUserOp(userOp, "test_SendBatch10CallWithWebAuthnSessionKeyDirectAA");
    }

    function test_SendBatch10CallWithWebAuthnSessionKeyDirectAASponsored() external {
        bytes memory data = abi.encodeWithSelector(IERC20.transfer.selector, reciver, 10e18);
        Call[] memory calls = _getCalls(10, address(erc20), 0, data);
        ...
        _relayUserOp(userOp, "test_SendBatch10CallWithWebAuthnSessionKeyDirectAASponsored");
    }

    function test_SendBatch10CallWithWebAuthnSessionKeyDirectAASponsoredERC20() external {
        bytes memory data = abi.encodeWithSelector(IERC20.transfer.selector, reciver, 10e18);
        Call[] memory calls = _getCalls(10, address(erc20), 0, data);
        ...
        _relayUserOp(userOp, "test_SendBatch10CallWithWebAuthnSessionKeyDirectAASponsoredERC20");
    }
