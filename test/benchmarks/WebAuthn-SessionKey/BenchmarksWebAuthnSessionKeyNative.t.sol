...
contract BenchmarksWebAuthnSessionKeyNative is DeployAccount {
    ...
    function test_SendNativeCallWithWebAuthnSessionKeyDirectAA() external {
        ...
        _relayUserOp(userOp, "test_SendNativeCallWithWebAuthnSessionKeyDirectAA");
    }

    function test_SendNativeCallWithWebAuthnSessionKeyDirectAASponsored() external {
        Call[] memory calls = _getCalls(1, reciver, 0.1 ether, hex"");
        ...
        _relayUserOp(userOp, "test_SendNativeCallWithWebAuthnSessionKeyDirectAASponsored");
    }

    function test_SendNativeCallWithWebAuthnSessionKeyDirectAASponsoredERC20() external {
        Call[] memory calls = _getCalls(1, reciver, 0.1 ether, hex"");
        ...
        _relayUserOp(userOp, "test_SendNativeCallWithWebAuthnSessionKeyDirectAASponsoredERC20");
    }
