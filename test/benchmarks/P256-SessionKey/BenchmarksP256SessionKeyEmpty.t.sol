...
contract BenchmarksP256SessionKeyEmpty is DeployAccount {
    ...
    function test_SendEmptyCallWithP256SessionKeyDirectAA() external {
        ...
        _relayUserOp(userOp, "test_SendEmptyCallWithP256SessionKeyDirectAA");
    }

    function test_SendEmptyCallWithP256SessionKeyAASponsored() external {
        Call[] memory calls = _getCalls(1, reciver, 0 ether, hex"");
        ...
        _relayUserOp(userOp, "test_SendEmptyCallWithP256SessionKeyAASponsored");
    }

    function test_SendEmptyCallWithP256SessionKeyAASponsoredERC20() external {
        Call[] memory calls = _getCalls(1, reciver, 0 ether, hex"");
        ...
        _relayUserOp(userOp, "test_SendEmptyCallWithP256SessionKeyAASponsoredERC20");
    }
