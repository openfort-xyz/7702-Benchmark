...
contract BenchmarksP256SessionKeyUniswapV2 is DeployAccount {
    ...
    function test_SendUniswapV2CallWithP256SessionKeyDirectAA() external {
        ...
        _relayUserOp(userOp, "test_SendUniswapV2CallWithP256SessionKeyDirectAA");
    }

    function test_SendUniswapV2CallWithP256SessionKeyAASponsored() external {
        bytes memory data = _uniswapV2SwapPayload();
        Call[] memory calls = _getCalls(1, _UNISWAP_V2_ROUTER_ADDRESS, 0, data);
        ...
        _relayUserOp(userOp, "test_SendUniswapV2CallWithP256SessionKeyAASponsored");
    }

    function test_SendUniswapV2CallWithP256SessionKeyAASponsoredERC20() external {
        bytes memory data = _uniswapV2SwapPayload();
        Call[] memory calls = _getCalls(1, _UNISWAP_V2_ROUTER_ADDRESS, 0, data);
        ...
        _relayUserOp(userOp, "test_SendUniswapV2CallWithP256SessionKeyAASponsoredERC20");
    }
