...
contract BenchmarksP256SessionKeyTransferERC20 is DeployAccount {
    ...
    function test_SendTransferERC20CallWithP256SessionKeyDirectAA() external {
        ...
        _relayUserOp(userOp, "test_SendTransferERC20CallWithP256SessionKeyDirectAA");
    }

    function test_SendTransferERC20CallWithP256SessionKeyAASponsored() external {
        bytes memory data = abi.encodeWithSelector(IERC20.transfer.selector, reciver, 10e18);
        Call[] memory calls = _getCalls(1, address(erc20), 0, data);
        ...
        _relayUserOp(userOp, "test_SendTransferERC20CallWithP256SessionKeyAASponsored");
    }

    function test_SendTransferERC20CallWithP256SessionKeyAASponsoredERC20() external {
        bytes memory data = abi.encodeWithSelector(IERC20.transfer.selector, reciver, 10e18);
        Call[] memory calls = _getCalls(1, address(erc20), 0, data);
        ...
        _relayUserOp(userOp, "test_SendTransferERC20CallWithP256SessionKeyAASponsoredERC20");
    }
