...
contract BenchmarksRootKeyTransferERC20 is DeployAccount {
    ...
    function test_TransferERC20CallWithRootKeyDirect() external {
        ...
        vm.snapshotGasLastCall("test_TransferERC20CallWithRootKeyDirect");
        VmSafe.Gas memory gas = vm.lastCallGas();
    }

    function test_TransferERC20CallWithRootKeyDirectAA() external {
        bytes memory data = abi.encodeWithSelector(IERC20.transfer.selector, reciver, 10e18);
        Call[] memory calls = _getCalls(1, address(erc20), 0, data);
        ...
        _relayUserOp(userOp, "test_TransferERC20CallWithRootKeyDirectAA");
    }

    function test_TransferERC20CallWithRootKeyDirectAASponsored() external {
        bytes memory data = abi.encodeWithSelector(IERC20.transfer.selector, reciver, 10e18);
        Call[] memory calls = _getCalls(1, address(erc20), 0, data);
        ...
        _relayUserOp(userOp, "test_TransferERC20CallWithRootKeyDirectAASponsored");
    }

    function test_TransferERC20CallWithRootKeyDirectAASponsoredERC20() external {
        bytes memory data = abi.encodeWithSelector(IERC20.transfer.selector, reciver, 10e18);
        Call[] memory calls = _getCalls(1, address(erc20), 0, data);
        ...
        _relayUserOp(userOp, "test_TransferERC20CallWithRootKeyDirectAASponsoredERC20");
    }
