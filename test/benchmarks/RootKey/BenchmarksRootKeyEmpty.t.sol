...
contract BenchmarksRootKeyEmpty is DeployAccount {
    ...
    function test_SendEmptyCallWithRootKeyDirectAASponsoredERC20() external {
        Call[] memory calls = _getCalls(1, reciver, 0 ether, hex"");
        ...
        _relayUserOp(userOp, "test_SendEmptyCallWithRootKeyDirectAASponsoredERC20");
    }
