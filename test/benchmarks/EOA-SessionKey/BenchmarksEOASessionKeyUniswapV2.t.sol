...
contract BenchmarksEOASessionKeyUniswapV2 is DeployAccount {
    ...
    function test_SendUniswapV2CallWithEOASessionKeyDirectAA() external {
        ...
        _relayUserOp(userOp, "test_SendUniswapV2CallWithEOASessionKeyDirectAA");
    }

    function test_SendUniswapV2CallWithEOASessionKeyDirectAASponsored() external {
        bytes memory data = _uniswapV2SwapPayload();
        Call[] memory calls = _getCalls(1, _UNISWAP_V2_ROUTER_ADDRESS, 0, data);
        ...
        _relayUserOp(userOp, "test_SendUniswapV2CallWithEOASessionKeyDirectAASponsored");
    }

    function test_SendUniswapV2CallWithEOASessionKeyDirectAASponsoredERC20() external {
        bytes memory data = _uniswapV2SwapPayload();
        Call[] memory calls = _getCalls(1, _UNISWAP_V2_ROUTER_ADDRESS, 0, data);
        ...
        _relayUserOp(userOp, "test_SendUniswapV2CallWithEOASessionKeyDirectAASponsoredERC20");
    }
