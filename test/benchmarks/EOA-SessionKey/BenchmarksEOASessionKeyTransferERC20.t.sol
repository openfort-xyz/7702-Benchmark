...
contract BenchmarksEOASessionKeyTransferERC20 is DeployAccount {
    ...
    function test_SendTransferERC20CallWithEOASessionKeyDirectAA() external {
        ...
        _relayUserOp(userOp, "test_SendTransferERC20CallWithEOASessionKeyDirectAA");
    }

    function test_SendTransferERC20CallWithEOASessionKeyDirectAASponsored() external {
        bytes memory data = abi.encodeWithSelector(IERC20.transfer.selector, reciver, 10e18);
        Call[] memory calls = _getCalls(1, address(erc20), 0, data);
        ...
        _relayUserOp(userOp, "test_SendTransferERC20CallWithEOASessionKeyDirectAASponsored");
    }

    function test_SendTransferERC20CallWithEOASessionKeyDirectAASponsoredERC20() external {
        bytes memory data = abi.encodeWithSelector(IERC20.transfer.selector, reciver, 10e18);
        Call[] memory calls = _getCalls(1, address(erc20), 0, data);
        ...
        _relayUserOp(userOp, "test_SendTransferERC20CallWithEOASessionKeyDirectAASponsoredERC20");
    }
