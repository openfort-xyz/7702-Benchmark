...
contract BenchmarksWebAuthnMasterKeyNative is DeployAccount {
    ...
    function test_SendNativeCallWithWebAuthnMasterKeyDirectAA() external {
        ...
        _relayUserOp(userOp, "test_SendNativeCallWithWebAuthnMasterKeyDirectAA");
    }

    function test_SendNativeCallWithWebAuthnMasterKeyDirectAASponsored() external {
        Call[] memory calls = _getCalls(1, reciver, 0.1 ether, hex"");
        ...
        _relayUserOp(userOp, "test_SendNativeCallWithWebAuthnMasterKeyDirectAASponsored");
    }

    function test_SendNativeCallWithWebAuthnMasterKeyDirectAASponsoredERC20() external {
        Call[] memory calls = _getCalls(1, reciver, 0.1 ether, hex"");
        ...
        _relayUserOp(userOp, "test_SendNativeCallWithWebAuthnMasterKeyDirectAASponsoredERC20");
    }
