...
contract BenchmarksEOASessionKeyCustodialNative is DeployAccount {
    ...
    function test_SendNativeCallWithEOASessionKeyCustodialDirectAA() external {
        ...
        _relayUserOp(userOp, "test_SendNativeCallWithEOASessionKeyCustodialDirectAA");
    }

    function test_SendNativeCallWithEOASessionKeyCustodialDirectAASponsored() external {
        Call[] memory calls = _getCalls(1, reciver, 0.3 ether, hex"");
        ...
        _relayUserOp(userOp, "test_SendNativeCallWithEOASessionKeyCustodialDirectAASponsored");
    }

    function test_SendNativeCallWithEOASessionKeyCustodialDirectAASponsoredERC20() external {
        Call[] memory calls = _getCalls(1, reciver, 0.3 ether, hex"");
        ...
        _relayUserOp(userOp, "test_SendNativeCallWithEOASessionKeyCustodialDirectAASponsoredERC20");
    }
