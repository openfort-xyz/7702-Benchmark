...
contract BenchmarksEOASessionKeyCustodialEmpty is DeployAccount {
    ...
    function test_SendEmptyCallWithEOASessionKeyCustodialDirectAA() external {
        ...
        _relayUserOp(userOp, "test_SendEmptyCallWithEOASessionKeyCustodialDirectAA");
    }

    function test_SendEmptyCallWithEOASessionKeyCustodialAASponsored() external {
        Call[] memory calls = _getCalls(1, reciver, 0 ether, hex"");
        ...
        _relayUserOp(userOp, "test_SendEmptyCallWithEOASessionKeyCustodialDirectAASponsored");
    }

    function test_SendEmptyCallWithEOASessionKeyCustodialAASponsoredERC20() external {
        Call[] memory calls = _getCalls(1, reciver, 0 ether, hex"");
        ...
        _relayUserOp(userOp, "test_SendEmptyCallWithEOASessionKeyCustodialDirectAASponsoredERC20");
    }
