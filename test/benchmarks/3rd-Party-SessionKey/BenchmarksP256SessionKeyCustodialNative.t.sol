...
contract BenchmarksP256SessionKeyCustodialNative is DeployAccount {
    ...
    function test_SendNativeCallWithP256SessionKeyCustodialDirectAA() external {
        ...
        _relayUserOp(userOp, "test_SendNativeCallWithP256SessionKeyCustodialDirectAA");
    }

    function test_SendNativeCallWithP256SessionKeyCustodialAASponsored() external {
        Call[] memory calls = _getCalls(1, reciver, 0.3 ether, hex"");
        ...
        _relayUserOp(userOp, "test_SendNativeCallWithP256SessionKeyCustodialAASponsored");
    }

    function test_SendNativeCallWithP256SessionKeyCustodialAASponsoredERC20() external {
        Call[] memory calls = _getCalls(1, reciver, 0.3 ether, hex"");
        ...
        _relayUserOp(userOp, "test_SendNativeCallWithP256SessionKeyCustodialAASponsoredERC20");
    }
