...
contract NativeTransferPaymasterERC20 is BaseBenchmark {
    function test_SendETH_UOP_ERC20_MODE_combinedByteBasic() public {
        vm.pauseGasMetering();
        _beginTest("NativeTransferPaymasterERC20", "test_SendETH_UOP_ERC20_MODE_combinedByteBasic");
        ...
        _flushTo(
            "test/Output/NativeTransferPaymaster/test_SendETH_UOP_ERC20_MODE_combinedByteBasic.json"
        );
    }
