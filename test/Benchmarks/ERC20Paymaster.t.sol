...
contract ERC20Paymaster is BaseBenchmark {
    function test_TransferErc20_UOP_VERIFYING_MODE() public {
        vm.pauseGasMetering();

        _beginTest("ERC20Paymaster", "test_TransferErc20_UOP_VERIFYING_MODE");
        ...
        _flushTo("test/Output/ERC20Paymaster/test_TransferErc20_UOP_VERIFYING_MODE.json");
    }
