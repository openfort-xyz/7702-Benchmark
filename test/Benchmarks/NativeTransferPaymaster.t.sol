...
contract NativeTransferPaymaster is BaseBenchmark {
    function test_SendETH_UOP_VERIFYING_MODE() public {
        vm.pauseGasMetering();
        _beginTest("NativeTransferPaymaster", "test_SendETH_UOP_VERIFYING_MODE");
        ...
        _flushTo("test/Output/NativeTransferPaymaster/test_SendETH_UOP_VERIFYING_MODE.json");
    }
