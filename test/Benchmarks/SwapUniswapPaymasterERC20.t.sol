...
contract SwapUniswapPaymasterERC20 is BaseBenchmark {
    struct NetAddrs {
        address weth;
        address usdc;
        bool routerLive;
    ...
    function test_SwapETHForUSDC_UOP_ERC20_MODE_combinedByteBasic() public {
        vm.pauseGasMetering();
        swapRouter = ISwapRouter(SWAP_ROUTER);
        weth = IWETH(WETH);
        _beginTest("SwapUniswap_Benchmark", "test_SwapETHForUSDC_UOP_ERC20_MODE_combinedByteBasic");
        ...
        _flushTo("test/Output/SwapUniswapPaymaster/test_SwapETHForUSDC_UOP_ERC20_MODE_combinedByteBasic.json");
    }
