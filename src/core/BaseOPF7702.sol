    ...
    IERC777Recipient
{
     ...
     * |------------------+------------------------------------------------------------+--------------------------------------------------------------------------------+--------+-------+------------------------------|
     * | idKeys           | mapping(uint256 => bytes32)                                |
     ...
     * src/core/OPFMain.sol:OPFMain |
     * |------------------+------------------------------------------------------------+--------------------------------------------------------------------------------+--------+-------+------------------------------|
     * | permissions      | mapping(bytes32 => struct IKeysManager.ExecutePermissions) |
     * 107588995614188179791452663824698570634674667931787294340862201729294267929603 | 0      | 32    |
     * src/core/OPFMain.sol:OPFMain |
     * |------------------+------------------------------------------------------------+--------------------------------------------------------------------------------+--------+-------+------------------------------|
     * | spendStore       | mapping(bytes32 => struct IKeysManager.SpendStorage)       |
     ...
     * |------------------+------------------------------------------------------------+--------------------------------------------------------------------------------+--------+-------+------------------------------|
     * | _initialized     | uint64                                                     |
     * 107588995614188179791452663824698570634674667931787294340862201729294267929606 | 0      | 8     |
     * src/core/OPFMain.sol:OPFMain |
     * |------------------+------------------------------------------------------------+--------------------------------------------------------------------------------+--------+-------+------------------------------|
     * | _initializing    | bool                                                       |
     * 107588995614188179791452663824698570634674667931787294340862201729294267929606 | 8      | 1     |
     * src/core/OPFMain.sol:OPFMain |
     * |------------------+------------------------------------------------------------+--------------------------------------------------------------------------------+--------+-------+------------------------------|
     ...
     * 107588995614188179791452663824698570634674667931787294340862201729294267929608 | 0      | 32    |
     * src/core/OPFMain.sol:OPFMain |
     * ╰------------------+------------------------------------------------------------+--------------------------------------------------------------------------------+--------+-------+------------------------------╯
     */
