...
interface IKeysManager {
    ...
    event TokenSpendSet(bytes32 indexed keyId, address indexed token, SpendPeriod period, uint256 limit);
     ...
     */
    function setTokenSpend(bytes32 _keyId, address _token, uint256 _limit, SpendPeriod _period) external;
     ...
     */
    function updateTokenSpend(bytes32 _keyId, address _token, uint256 _limit, SpendPeriod _period) external;
